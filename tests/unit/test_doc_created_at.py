...
class TestUpsertDocCreatedAt:
    ...
    def test_upsert_result_carries_doc_created_at(self, mock_qdrant):
        ...
        with (
            patch("rag_api.pipeline.ops.upsert.qdrant_infra.get_qdrant_client", return_value=mock_qdrant),
            patch("rag_api.pipeline.ops.upsert.qdrant_infra.ensure_collection"),
            patch("rag_api.pipeline.ops.upsert.qdrant_infra.delete_chunks_by_doc_id"),
            patch("rag_api.pipeline.ops.upsert.qdrant_infra.upsert_chunks"),
        ):
    ...
    def test_qdrant_payload_includes_doc_created_at(self, mock_qdrant):
        ...
        with (
            ...
            patch("rag_api.pipeline.ops.upsert.qdrant_infra.ensure_collection"),
            patch("rag_api.pipeline.ops.upsert.qdrant_infra.delete_chunks_by_doc_id"),
            patch("rag_api.pipeline.ops.upsert.qdrant_infra.upsert_chunks", side_effect=capture_upsert),
        ):
    ...
    def test_qdrant_payload_uses_doc_id_not_doc_key(self, mock_qdrant):
        ...
        with (
            ...
            patch("rag_api.pipeline.ops.upsert.qdrant_infra.ensure_collection"),
            patch("rag_api.pipeline.ops.upsert.qdrant_infra.delete_chunks_by_doc_id"),
            patch("rag_api.pipeline.ops.upsert.qdrant_infra.upsert_chunks", side_effect=lambda kb, pts, client=None: captured_points.extend(pts)),
        ):
            upsert("kb-test", DOC_ID, [en])
