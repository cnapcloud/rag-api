...
def test_ingest_job_validate_passes(ingest_run_config):
    ...
    with (
        ...
        patch("pipeline.ops.dedup.simhash.run_simhash_detection",
              return_value=DedupResult(verdict="proceed", needs_indexing=True)),
        patch("pipeline.ops.dedup.verdict.run_verdict"),
