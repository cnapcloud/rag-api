...
- [파서 레지스트리(US-41) 도입 배경](parser_registry_design_rationale.md) — rag-api 공개 확정으로 비공개 파서(캡셔닝/OCR)를 rag-ent-api에서 주입해야 함, design 문서 자체도 비공개 대상임을 놓치기 쉬움 (2026-07-15)
