...
- [의견만 물었을 때 바로 편집/커밋/push 금지](feedback_confirm_before_edit.md) — 제안형 질문은 동의 요청이지 실행 지시가 아님; commit·push는 매번 별도 명시 요청 필요, spec 워크플로우 중 문제 발견 시 임의로 고치지 말고 설계된 blocked 경로부터 (2026-09-13)
